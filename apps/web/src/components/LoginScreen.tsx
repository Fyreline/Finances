...
/** Household sign-in — port of the siblings' LoginScreen.tsx styling
 * (docs/DESIGN.md). There is no registration path anywhere: this form only
 * ever has one possible "correct" answer, and the credential is Mishka
 * Hub's own (docs/AUTH.md). */
    ...
    <div className="flex min-h-full items-center justify-center bg-paper px-5 text-ink">
      <div className="w-full max-w-sm">
        <div className="mb-8 flex flex-col items-center gap-3 text-center">
          <KakeiboMark className="h-11 w-11" />
          <span className="font-display text-xl font-medium tracking-[-0.005em]">
            Kakeibo <span className="text-clay">家計簿</span>
          </span>
          <p className="font-serif text-base text-ink-mid">
            A calm, honest ledger of what came in, what went out.
          </p>
        </div>
