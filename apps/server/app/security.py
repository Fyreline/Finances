...
Ported from the siblings' app/security.py per docs/AUTH.md: the password-
hashing functions and their password-hashing-library import are deleted
entirely — Kakeibo never stores, hashes, or even sees a hash of a password
(there is no password-hashing dependency anywhere in requirements.txt; that
absence is the proof Kakeibo holds no passwords).
"""
