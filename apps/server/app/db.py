...
Mirrors docs/DATA_MODEL.md and the siblings' app/db.py. This module only
builds the engine/session machinery; table creation (and category seeding)
is done once on startup in app/main.py's lifespan (SQLite; no Alembic in
Phase 1 — see docs/ARCHITECTURE.md §4).
"""
